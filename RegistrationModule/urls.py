...
urlpatterns=[
    ...
    path('StudentCourseDisplay.html',views.studentCourseDisplay,name='teacherCourseDisplay'),
    path('AddStudentCourse',views.addStudentCourse,name='addStudentCourse'),
    path('RemoveStudentCourse',views.removeStudentCourse,name='removeStudentCourse'),
